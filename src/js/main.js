  ...
  $('#townPhotos').each(function() {
    ...
    function addItems() {
      ...
      $.each(slicedData, function(i, item) {
        ...
        // 撮影日時をフォーマット
        var imgtime = time.getFullYear() + '-' +
                      doubleDigits(time.getMonth() + 1) + '-' +
                      doubleDigits(time.getDate()) + ' ' +
                      doubleDigits(time.getHours()) + ':' +
                      doubleDigits(time.getMinutes());
              ...
              '<div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">' +
                '<div class="panel">' +
                  '<div class="panel-body">' +
                    ...
                    '<div ' +
                      'class="panel-body-cover" ' +
                      'data-toggle="modal" ' +
                      'data-target="#modal" ' +
                      'data-img="'      + img + '" ' +
                      'data-page="'     + page + '" ' +
                      'data-imgtime="'  + imgtime + '" ' +
                      'data-captext="'  + captext + '" ' +
                      'data-name="'     + name + '" ' +
                  ...
                  '<div class="panel-footer">' +
                    ...
                    '>' +
                      ...
                      locname +
                    '</div>' +
                    '<a class="imgtime" href="' + page + '" target="_blank">' +
